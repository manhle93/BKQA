    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="https://1.bp.blogspot.com/-c9hDz_-Jh9c/XbvtBdEp_4I/AAAAAAAAADs/V97AHWrcGOUCwP__wLdDgNqW7CC2cOZUgCLcBGAsYHQ/s1600/logo.png" style="width: 320px; height: 70px; margin-left: 40px">
                </a>
...
<footer>
    <img src="https://1.bp.blogspot.com/-gsKuc4e3GZI/XbvsRxSXgaI/AAAAAAAAADQ/ig66_WjV044XRjsluCyGPdwLUjIuehOuQCLcBGAsYHQ/s1600/footer.png" style="width: 100%">
</footer>
