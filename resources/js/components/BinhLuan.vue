          ...
          <div class="col-md-3">
            <el-tooltip class="item" effect="dark" content="Vote" placement="top">
              <a @click="vote(cautraloi.id)">
                <img
                  src="https://1.bp.blogspot.com/-MCiCY-OPm9I/Xbvtw9UYVSI/AAAAAAAAAEA/k7gxodurA8IorN10Cvcw_daaZzpIUErNQCLcBGAsYHQ/s1600/vote.png"
            ...
            <el-tooltip class="item" effect="dark" content="Bỏ Vote" placement="top">
              <a>
                <img
                  src="https://1.bp.blogspot.com/-hdfxV-hLg0g/Xbvtw9OumvI/AAAAAAAAAEE/6w0kqHBmlVMGjz0KsMHesuLocQr9oH0wwCLcBGAsYHQ/s1600/unvote.png"
                  v-if="user_login !=null && (cautraloi.votes.find(x=>x.user_id == user_login.id) != x)"
